...
// Adding LOCs 
func (t *SimpleChaincode) addLoc(stub shim.ChaincodeStubInterface, args []string) ([]byte,error){
  var err error;
  var counter1 int;
...
// Return specific LOC in the system
    func (t *SimpleChaincode) getLoc(stub shim.ChaincodeStubInterface, args []string) ([]byte,error) {
 ...
 //Get number of LOCs in the system
    func (t *SimpleChaincode) getNumberOfLocs(stub shim.ChaincodeStubInterface, args []string) ([]byte, error){
        valAsbytes:=strconv.Itoa(counter);
        return []byte(valAsbytes), nil;
    }

    func (t *SimpleChaincode) updateLocStatus(stub shim.ChaincodeStubInterface, args []string) ([]byte, error){
 ...
 //upload Bol document
  func (t *SimpleChaincode) uploadBol(stub shim.ChaincodeStubInterface, args []string) ([]byte, error){
...
func (t *SimpleChaincode) getLocList(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
	var list []string;
 ...
 func (t *SimpleChaincode) uploadContract(stub shim.ChaincodeStubInterface, args []string) ([]byte, error){
